...
class SearchProductCard extends StatelessWidget {
  ...
  Function()? onTap;
  SearchProductCard({required this.searchProducts, this.onTap});
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    hGap12,
                    MyAssetImage(
                      imageName: searchProducts.image ?? "",
                      height: 120,
                      width: 120,
                    ),
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            hGap12,
                            MyText(
                              searchProducts.storeName ?? "",
                              style: labelLarge,
                              maxLines: 2,
                              textAlign: TextAlign.center,
                            ),
                            RatingComponent(
                              currentRating: searchProducts.currentRating,
                              maxRating: 5,
                              textRightSide: true,
                            ),
                            hGap8,
