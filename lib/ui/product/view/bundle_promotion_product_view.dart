...
class BundlePromotionProductView extends StatelessWidget {
                      ...
                      children: [
                        ...
                        MultipleImageComponent(
                          images: [
                            for (int index = 0;
                                index <
                                    (model.bundlePromotion?.products?.length ??
                                        0);
                                index++) ...[
                              model.bundlePromotion?.products?[index].image ??
                                  "",
                            ]
                          ],
                          texts: [
                            for (int index = 0;
                                index <
                                    (model.bundlePromotion?.products?.length ??
                                        0);
                                index++) ...[
                              model.bundlePromotion?.products?[index].name ??
                                  "",
                            ]
                          ],
                          onPageChanged: (value) =>
                              model.imageIndex.value = value,
                        ),
                        hGap12,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _addToCartSection(context,
                            model.bundlePromotion ?? BundlePromotion()),
                        hGap8,

                        /// Show product description
                        Obx(() => _productDescription(model)),
                        hGap8,

                        /// Show product ingredients
                        Obx(() => _productIngredients(model)),
                      ],
                    ),
                  ),
                ],
  ...
  Widget _ratingComponent(ProductViewModel model) {
    return RatingComponent(
      currentRating: model.bundlePromotion?.productRating,
  ...
  Widget _productDetails(ProductViewModel model) {
    return Column(
      ...
      children: [
        ...
        MyText(
          "${model.bundlePromotion?.quantity}",
          style: labelMedium,
        ),
        hGap12,
        MyText(
        ...
        Row(
          children: [
            MyText(
              "${model.bundlePromotion?.currency} ${model.bundlePromotion?.originalPrice}",
              style: model.bundlePromotion?.discountedPrice != 0.0
                  ? TextStyle(
            ...
            wGap4,
            if (model.bundlePromotion?.discountedPrice != 0.0)
              MyText(
                "${model.bundlePromotion?.currency} ${model.bundlePromotion?.discountedPrice}",
                style: TextStyle(
                  color: greenColor,
  ...
  Widget _addToCartSection(
      BuildContext context, BundlePromotion bundlePromotion) {
    return Wrap(
        ...
        MyButton(
          ...
          onPressed: () {
            DashboardViewModel.load()
                .addToCart(bundlePromotion: bundlePromotion);
            model.notify();
          },
        ),
        wGap4,
        MyText(
          "${bundlePromotion.piecesAvailable} Pieces Available",
          maxLines: 2,
        ),
      ],
    );
  ...
  Widget _productDescription(ProductViewModel model) {
    return Column(
      ...
      children: [
        ...
        hGap4,
        MyText(
          model.bundlePromotion?.products?[model.imageIndex.value]
                  .description ??
              "",
        ),
      ],
